Contributing to CazCoin Core
============================

The CazCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CazCoin Core project, and is not to be
confused with overall CazCoin Network Protocol consensus changes.

Whether a pull request is merged into CazCoin Core rests with the project merge
...
Patches that change CazCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CazCoin consensus, it must have been
...
The project leader is the release manager for each CazCoin Core release.
