...
RESOURCES += src/qt/cazcoin.qrc src/qt/cazcoin_locale.qrc

TRANSLATIONS += src/qt/locale/cazcoin_bg.ts \
                src/qt/locale/cazcoin_de.ts \
                src/qt/locale/cazcoin_en.ts \
                src/qt/locale/cazcoin_es.ts \
                src/qt/locale/cazcoin_fi.ts \
                src/qt/locale/cazcoin_fr.ts \
                src/qt/locale/cazcoin_it.ts \
                src/qt/locale/cazcoin_ja.ts \
                src/qt/locale/cazcoin_pl.ts \
                src/qt/locale/cazcoin_pt.ts \
                src/qt/locale/cazcoin_ru.ts \
                src/qt/locale/cazcoin_sk.ts \
                src/qt/locale/cazcoin_sv.ts \
                src/qt/locale/cazcoin_vi.ts \
                src/qt/locale/cazcoin_zh_CN.ts \
                src/qt/locale/cazcoin_zh_TW.ts
