...
In order to support loading of multiple wallets in cazcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cazcoin.cpp.
...
Changes to cazcoin.cpp
----------------------
cazcoin.cpp is the entry point into cazcoin-qt, and as such, will require some minor modifications to provide hooks for
