CazCoin Core version 2.2.1 is now available from:
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/copicogithub1/cazcoin/issues>

Compatibility
==============

CazCoin Core is extensively tested on multiple operating systems using
...
CazCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that CazCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/cazcoin-project-translations/).
