                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CazCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CazCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cazcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CazCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CazCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CazCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CazCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CazCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CazCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CazCoin Core help message to get a list with possible CazCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CazCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CazCoin network", "", count));
}
...
{
    QString strTitle = tr("CazCoin Core"); // default title
