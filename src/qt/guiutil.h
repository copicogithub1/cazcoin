...
/** Utility functions used by the CazCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CazCoin addresses in monospace font
...
// Parse "cazcoin:" URI into recipient object, return true on successful parsing
