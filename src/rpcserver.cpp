...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "CazCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CazCoin features */
        {"cazcoin", "masternode", &masternode, true, true, false},
        {"cazcoin", "masternodelist", &masternodelist, true, true, false},
        {"cazcoin", "mnbudget", &mnbudget, true, true, false},
        {"cazcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"cazcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cazcoin", "mnsync", &mnsync, true, true, false},
        {"cazcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"cazcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cazcoind, or the -server option to cazcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cazcoin-cli " + methodname + " " + args + "\n";
}
