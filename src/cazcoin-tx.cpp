...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CazCoin Core cazcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cazcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cazcoin transaction") + "\n" +
                               "  cazcoin-tx [options] -create [commands]   " + _("Create hex-encoded cazcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cazcoin transaction
